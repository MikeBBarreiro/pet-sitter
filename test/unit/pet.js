...
describe('Pet', function() {
  ...
  describe('#walk', function(){
    it('should increase health but decrease energy and fullness', function(){
      var pet = new Pet('fluffy', 3, 'female', 'lizard' );
      pet.health = 90;
      pet.energy = 30;
      pet.full   = 20;
  ...
  describe('#eat', function(){
    it('should increase health and full  but decreases energy', function(){
      ...
      expect(pet.full).to.be.within(15,29);
    });
  });
  ...
  it('Should cause a pet with negitive health to become a zombie', function(){
  ...
  describe('#ressurrect', function(){
    ...
    it('it should not ressurrect', function(){
